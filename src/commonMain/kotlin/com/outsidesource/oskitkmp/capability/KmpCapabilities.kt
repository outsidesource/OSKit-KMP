...
internal expect fun createPlatformNearbyWifiDevicesCapability(): IKmpCapability
...
class KmpCapabilities(
    ...
    val nearbyWifiDevicesCapability: IKmpCapability = createPlatformNearbyWifiDevicesCapability()
    ...
    fun init(context: KmpCapabilityContext) {
        ...
        (nearbyWifiDevicesCapability as? IInitializableKmpCapability)?.init(context)
    }
}
