...
internal expect fun createPlatformMicrophoneCapability(): IKmpCapability
...
class KmpCapabilities(
    ...
    val microphone: IKmpCapability = createPlatformMicrophoneCapability()
    ...
    fun init(context: KmpCapabilityContext) {
        ...
        (microphone as? IInitializableKmpCapability)?.init(context)
    }
}
